...
public class ExcelWriter {
    ...
    static {
        ...
        employees.add(new Employee("nnnn", "wgaurav25@gmail.com",
                dateOfBirth.getTime(), 1200000.0));

        dateOfBirth.set(1965, 10, 15);
        employees.add(new Employee("ggggg", "dabbang@mail.com",
                dateOfBirth.getTime(), 1500000.0));

        dateOfBirth.set(1987, 4, 18);
        employees.add(new Employee("yyyy", "raja@example.com",
    ...
    public static void main(String[] args) throws IOException, InvalidFormatException {
        ...
        FileOutputStream fileOut = new FileOutputStream("D:\\sheet\\abc.xlsx");
    ...
    private static void modifyExistingWorkbook() throws InvalidFormatException, IOException {
        ...
        Workbook workbook = WorkbookFactory.create(new File("D:\\sheet\\abc.xlsx"));
